...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cf-demo-project)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cf-demo-project
```

A live public deployment of this template is available at [https://cf-demo-project.templates.workers.dev](https://cf-demo-project.templates.workers.dev)
